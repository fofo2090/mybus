...
class DatabaseService {
  ...
  Future<void> linkStudentToParent(String studentId, String parentId) async {
    try {
      ...
      // Create or update parent-student link document
      final linkDocRef = _firestore.collection('parentStudentLinks').doc('${parentId}_$studentId');
